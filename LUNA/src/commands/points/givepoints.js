...
module.exports = class GivePointsCommand extends Command {
    constructor(client) {
        super(client, {
            ...
            examples: ['givepoints @PinkyPeaker#9165 1000']
        });
    }
    ...
    `);
        ...
        let description;
        if (amount === 1) description = `${emojis.success} Successfully transferred **${amount}** points ${emojis.point} to ${member}!`;
        else description = `${emojis.success} Successfully transferred **${amount}** points ${emojis.point} to ${member}!`;
