...
module.exports = class MuteCommand extends Command {
    constructor(client) {
        super(client, {
            ...
            examples: ['mute @PinkyPeaker 10s', 'mute @PinkyPeaker 30m talks too much'],
            exclusive: true
        });
    }
    ...
    async run(message, args) {
        ...
        message.channel.send({
            embeds: [new MessageEmbed().setTitle('Mute Member')
                .setDescription(`Do you want to mute ${member} for **${ms(time, {long: true})}**?`).setFooter({text: `Expires in 15s`})],
            components: [row]
        }).then(async msg => {
            ...
            collector.on('collect', async b => {
                ...
                if (b.customId === 'proceed') {
                    ...
                    updated = true;
                    msg.edit({
                        components: [], embeds: [new MessageEmbed().setTitle('Mute Member')
